...
TEST_F(CommandBufferAlgorithmFixture, ignoreCommand7) {
	std::vector<Arg> buffer = { {ERASE,0,"5"},{ERASE,0,"5"},{EMPTY,},{EMPTY,},{EMPTY,} };
	std::vector<Arg> expected = { {ERASE,0,"5"},{EMPTY,},{EMPTY,},{EMPTY,},{EMPTY,} };
	std::vector<Arg> ret = cba.ignoreCommand(buffer);
...
TEST_F(CommandBufferAlgorithmFixture, ignoreCommand8) {
	std::vector<Arg> buffer = { {ERASE,95,"5"},{ERASE,95,"5"},{EMPTY,},{EMPTY,},{EMPTY,} };
	std::vector<Arg> expected = { {ERASE,95,"5"},{EMPTY,},{EMPTY,},{EMPTY,},{EMPTY,} };
	std::vector<Arg> ret = cba.ignoreCommand(buffer);
...
TEST_F(CommandBufferAlgorithmFixture, ignoreCommand10) {
	std::vector<Arg> buffer = { {ERASE,10,"5"},{WRITE,14,"0xABCD1234"},{EMPTY,},{EMPTY,},{EMPTY,} };
	std::vector<Arg> expected = { {ERASE,10,"4"},{WRITE,14,"0xABCD1234"},{EMPTY,},{EMPTY,},{EMPTY,} };
	std::vector<Arg> ret = cba.ignoreCommand(buffer);
